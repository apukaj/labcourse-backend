...
namespace LabCourseProject.Controllers
{
    ...
    [ApiController]
    public class Promotions1Controller : ControllerBase
    {
        private readonly DataContext _context;

        public Promotions1Controller(DataContext context)
        {
            _context = context;
        }
